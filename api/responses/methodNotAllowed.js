 ...
 *     // -or-
 *     return res.methodNotAllowed(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function methodNotAllowed(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.methodNotAllowed()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.methodNotAllowed()` called with an Error:', optionalData);
